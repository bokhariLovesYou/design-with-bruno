...
import AniLink from "gatsby-plugin-transition-link/AniLink";
  ...
  class ChoiceComponent extends Component {
    ...
    return (
		...
		<AniLink cover to={this.props.redirect} entry={{ state: {quizTaken: true}}} duration={0.4} bg={this.props.charColor}><div onClick={() => this.props.handleQuestionChange(index)} className={this.props.classes}>
